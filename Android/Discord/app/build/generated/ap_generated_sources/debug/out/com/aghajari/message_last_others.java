...
public class message_last_others extends LinearLayout {
    ...
    public message_last_others(Context context) {
        this(context, null);
    }

    public message_last_others(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public message_last_others(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	protected void initView1() {
		...
		view1.setBackgroundResource(R.drawable.message_last_others);
