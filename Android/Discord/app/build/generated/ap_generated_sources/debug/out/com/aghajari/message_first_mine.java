...
public class message_first_mine extends LinearLayout {
    ...
    public message_first_mine(Context context) {
        this(context, null);
    }

    public message_first_mine(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public message_first_mine(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	protected void initView1() {
		...
		view1.setBackgroundResource(R.drawable.message_first_mine);
