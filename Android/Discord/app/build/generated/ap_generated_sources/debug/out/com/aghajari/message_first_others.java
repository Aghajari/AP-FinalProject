...
public class message_first_others extends LinearLayout {
    ...
    public message_first_others(Context context) {
        this(context, null);
    }

    public message_first_others(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public message_first_others(Context context, AttributeSet attrs, int defStyleAttr) {
