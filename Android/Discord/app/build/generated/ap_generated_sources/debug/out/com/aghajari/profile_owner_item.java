...
public class profile_owner_item extends LinearLayout {
    ...
    public profile_owner_item(Context context) {
        this(context, null);
    }

    public profile_owner_item(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public profile_owner_item(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	protected void initIcon() {
		icon = new AppCompatImageView(getContext());
		icon.setId(R.id.icon);
		icon.setImageResource(R.drawable.gradient2_rad);
		LinearLayout.LayoutParams icon_lp = new LinearLayout.LayoutParams(dp(28f), dp(28f));
		icon_lp.gravity = Gravity.CENTER_VERTICAL;
		this.addView(icon, icon_lp);
	}
